...
The assessment is divided into two distinct modules:
1.  **Module 1: Aptitude:** A set of 20 questions to test your basic analytics, logical reasoning, and critical thinking skills.
2.  **Module 2: Technical Assessment:** A series of questions covering Python, Deep Learning, Git, ReactJS, and AWS, including practical programming challenges.
`;

export const QUESTIONS: Question[] = [
  // MODULE 1 – Aptitude (20 Questions)
  {
    id: 'apt_1',
    section: 'Module 1: Aptitude',
  ...
  // MODULE 2 – Technical Assessment
  {
    id: 'tech_py_1',
    section: 'Module 2: Python',
  ...
  {
    id: 'tech_dl_1',
    section: 'Module 2: Deep Learning',
  ...
  {
    id: 'tech_py_prog_1',
    section: 'Module 2: Python Programming',
